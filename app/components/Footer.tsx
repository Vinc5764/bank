      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center mb-8">
          ...
          <div className="text-center mb-6 lg:mb-0">
            ...
            <div className=" font-bold text-[#A4167A] mt-2">FOR PRESIDENT</div>
          </div>
            ...
            <div className="flex justify-center space-x-4 mb-4">
              {[
                ...
                <a
                  key={social}
                  href={`#${social}`}
                  className="bg-navy-700 p-2 rounded-full hover:bg-navy-600 transition"
                >
        ...
        <div className="text-center text-sm">
          <p className="mb-2">
            PO Box 3740, Ghana, | Phone: +233 543870298 | E-mail:
            info@johnkpikpi.com
          </p>
          ...
          <p>
            Copyright © 2024 John Kpikpi for President. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
